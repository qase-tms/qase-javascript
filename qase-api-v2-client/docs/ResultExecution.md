...
**error_context** | **string** | Free-form failure context captured by the reporter. For Playwright this is the content of error-context.md (test info, error details, page snapshot). Stored verbatim so it can be copied as raw text. Truncated at 262144 characters. | [optional] [default to undefined]
