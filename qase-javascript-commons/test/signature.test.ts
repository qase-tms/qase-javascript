...
describe('generateSignature', () => {
  it('should generate signature with all parameters', () => {
    ...
    expect(result).toBe("1-2-3::suite1::suite2::{'param1':'value1'}::{'param2':'value2'}");
  });
  ...
  it('should generate signature with null testopsIds', () => {
    ...
    expect(result).toBe("suite1::suite2::{'param1':'value1'}");
  });
  ...
  it('should generate signature with empty suites array', () => {
    ...
    expect(result).toBe("1-2-3::{'param1':'value1'}");
  });
