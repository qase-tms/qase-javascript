...
// @ts-ignore
import { GetAuthorsFiltersParameter } from '../model';
/**
...
export const AuthorsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAuthorsFiltersParameter} [filters] 
         * @param {number} [limit] A number of entities in result set.
         * @param {number} [offset] How many entities should be skipped.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAuthors: async (filters?: GetAuthorsFiltersParameter, limit?: number, offset?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AuthorsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAuthors(filters?: GetAuthorsFiltersParameter, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthorListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAuthors(filters, limit, offset, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AuthorsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAuthors(filters?: GetAuthorsFiltersParameter, limit?: number, offset?: number, options?: any): AxiosPromise<AuthorListResponse> {
            return localVarFp.getAuthors(filters, limit, offset, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AuthorsApi extends BaseAPI {
     ...
     * @memberof AuthorsApi
     */
    public getAuthors(filters?: GetAuthorsFiltersParameter, limit?: number, offset?: number, options?: AxiosRequestConfig) {
        return AuthorsApiFp(this.configuration).getAuthors(filters, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
}
