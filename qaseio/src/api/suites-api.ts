...
export const SuitesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSuites: async (code: string, limit?: number, offset?: number, filters?: object, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'code' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateSuite: async (code: string, id: number, suiteCreate: SuiteCreate, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'code' is not null or undefined
            assertParamExists('updateSuite', 'code', code)
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateSuite', 'id', id)
            // verify required parameter 'suiteCreate' is not null or undefined
            assertParamExists('updateSuite', 'suiteCreate', suiteCreate)
            const localVarPath = `/suite/{code}/{id}`
                .replace(`{${"code"}}`, encodeURIComponent(String(code)))
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const SuitesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getSuites(code: string, limit?: number, offset?: number, filters?: object, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SuiteListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSuites(code, limit, offset, filters, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This method is used to update a test suite through API. 
         ...
         * @throws {RequiredError}
         */
        async updateSuite(code: string, id: number, suiteCreate: SuiteCreate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSuite(code, id, suiteCreate, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const SuitesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSuites(code: string, limit?: number, offset?: number, filters?: object, options?: any): AxiosPromise<SuiteListResponse> {
            return localVarFp.getSuites(code, limit, offset, filters, options).then((request) => request(axios, basePath));
        },
        /**
         * This method is used to update a test suite through API. 
         * @summary Update test suite.
         ...
         * @throws {RequiredError}
         */
        updateSuite(code: string, id: number, suiteCreate: SuiteCreate, options?: any): AxiosPromise<IdResponse> {
            return localVarFp.updateSuite(code, id, suiteCreate, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SuitesApi extends BaseAPI {
     ...
     * @memberof SuitesApi
     */
    public getSuites(code: string, limit?: number, offset?: number, filters?: object, options?: AxiosRequestConfig) {
        return SuitesApiFp(this.configuration).getSuites(code, limit, offset, filters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SuitesApi
     */
    public updateSuite(code: string, id: number, suiteCreate: SuiteCreate, options?: AxiosRequestConfig) {
        return SuitesApiFp(this.configuration).updateSuite(code, id, suiteCreate, options).then((request) => request(this.axios, this.basePath));
    }
}
