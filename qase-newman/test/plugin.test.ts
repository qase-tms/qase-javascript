...
// describe('Tests', () => {
//   it('Init main class', () => {
//     new NewmanQaseReporter(
//       new EventEmitter(),
//       { apiToken: '', projectCode: '' },
//       { collection: '' },
//     );
//   });
//
...
//         const reporter = new NewmanQaseReporter(
//           new EventEmitter(),
//           { apiToken: '', projectCode: '' },
//           { collection: '' },
//         );
...
//         const reporter = new NewmanQaseReporter(
//           new EventEmitter(),
//           { apiToken: '', projectCode: '', environmentId: 5 },
//           { collection: '' },
//         );
...
//         const reporter = new NewmanQaseReporter(
//           new EventEmitter(),
//           { apiToken: '', projectCode: '', runComplete: true },
//           { collection: '' },
//         );
