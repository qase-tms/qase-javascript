...
//         expect(qReporter['resultsForPublishing'][index].defect).toBe(
//           testData[index].defect,
//         );
//       });
//     }
//   });
...
//     const runner = new mocha.Runner(new mocha.Suite('new'), false);
//     let qReporter = new QaseCypressReporter(runner, {
//       reporterOptions: { apiToken: '' },
//     });
...
//         err: null,
//       };
//       qReporter['transformCaseResultToBulkObject'](
//         test as any,
//         test.status as any,
//       );
...
//       qReporter = new QaseCypressReporter(runner, {
//         reporterOptions: { apiToken: '', rootSuiteTitle: 'Top Parent' },
//       });
//       const test = {
//         parent: {
//           title: 'Level 1',
...
//         const runner = new mocha.Runner(new mocha.Suite('new'), false);
//         const qReporter = new QaseCypressReporter(runner, {
//           reporterOptions: { apiToken: '' },
//         });
...
//         const runner = new mocha.Runner(new mocha.Suite('new'), false);
//         const qReporter = new QaseCypressReporter(runner, {
//           reporterOptions: { apiToken: '', rootSuiteTitle: 'CY Test' },
//         });
